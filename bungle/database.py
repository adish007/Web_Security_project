...
def connect():
    ...
    return mdb.connect(host='localhost', user='adishj2', password='423510c156a3f2680ee62f3fff42ca1c05fa87b05551f18fa5130b5dfe1017cc', db='project2')
...
def createUser(username, password):
    ...
    query = "INSERT INTO users (username, password, passwordhash) VALUES (%s, %s, %s)"
    cur.execute(query, (username, password, password_hash))
...
def addHistory(user_id, query):
    ...
    query_statement = "INSERT INTO history (user_id, query) VALUES (%s, %s)"
    cur.execute(query_statement, (user_id, query))
    db_rw.commit()
